...
func TestAddBooks(t *testing.T) {
	...
	tests := []struct {
		...
		output: res{[]Book{{title: "Book1", author: "Author1", ISBN: 1234}}, errors.New("")},
	},
	...
	tests := []struct {
		...
		{name: "Removing new different book",
			input: req{1234, []Book{{title: "Book1", author: "Author1", ISBN: 1234},
				{title: "Book2", author: "Author2", ISBN: 1456}}},
			output: res{[]Book{
				{title: "Book2", author: "Author2", ISBN: 1456}}, errors.New("")},
		},
...
func TestReturnBook(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Returning Book",
			input: req{1234, 1234, lend, []Book{{title: "Book1", author: "Author1", ISBN: 1234},
				{title: "Book2", author: "Author2", ISBN: 1456}}},
			output: res{"Book Returned Successfully", errors.New("")},
		},
